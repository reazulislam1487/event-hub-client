...
const Navbar = () => {
  ...
  return (
    <div className="bg-[#FFF9F0]  sticky top-0 z-50">
      <nav className="navbar mx-auto max-w-7xl  pl-0 pr-4 md:px-0  py-3  font-sans text-gray-700">
        <div className="navbar-start flex items-center ">
          ...
          <FaCalendarAlt className="text-[#F6C26B] mr-5 text-3xl" />
